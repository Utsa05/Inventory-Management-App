...
class ThanaService {
  static Future<List<ThanaModelNew>> getAllThana() async {
    //var response;
    String url = "${globalUrl}admin/thanas/";
    ...
    if (response.statusCode == 200) {
      ...
      List<ThanaModelNew> thanaList = [];
      for (var item in responseData) {
        ThanaModelNew user = ThanaModelNew(
            id: item["id"] as int,
            name: item["name"],
            createdAt: item["createdAt"],
            updatedAt: item["updatedAt"],
            districtId: item["districtId"],
            district: DistrictModelNew(
              id: item["id"] as int,
              name: item["name"],
              createdAt: item["createdAt"],
              updatedAt: item["updatedAt"],
  ...
  static Future<List<DistrictModelNew>> getAllThanaUser(
      {required String districtId}) async {
    //var response;
    //String url = "${globalUrl}user/projects/1/$districtId/thanas";
    String url = "${globalUrl}user/projects/1/districts/$districtId/thanas";
    ...
    if (response.statusCode == 200) {
      var responseData = json.decode(response.body);
      List<DistrictModelNew> thanaList = [];
      for (var item in responseData) {
