...
class BuildingService {
  static Future<bool> addBuilding(String thanaId, BuildingModel data) async {
    //var response;
    String url =
        "http://192.168.0.100:5000/api/admin/projects/1/thanas/1/buildings/";
  ...
  static Future<List<BuildingCreateResponseModel>> allBuildign(
    ...
    //var response;
    String url =
        "http://192.168.0.100:5000/api/admin/projects/1/thanas/$thanaId/buildings/";
  ...
  static Future<bool> deleteBuilding(String thanaId, String buildingId) async {
    //var response;
    String url =
        "http://192.168.0.100:5000/api/admin/projects/1/thanas/$thanaId/buildings/$buildingId";
